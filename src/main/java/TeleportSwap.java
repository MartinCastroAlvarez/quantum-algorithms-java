...
public class TeleportSwap {
    ...
    public static void main(String[] args) {
        ...
        // Inverting the state of the first 2 Qubits.
        step7.addGate(new Swap(0,1));

        // Adding a Z-Gate if the result of the first Qubit is 1.
        step8.addGate(new Cz(1,2));
        ...
        Arrays.asList(qubits).forEach(q -> TeleportSwap.measure(q));
